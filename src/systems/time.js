...
const KEYS = [
  { h:0.0,  zen:0x060a1c, hor:0x101a38, gnd:0x05070f, sun:0x223055, amb:0x0d1330, si:0.05, haze:0.35, fog:0x0a0f22, fogD:0.00144 },
  { h:5.4,  zen:0x1d2a52, hor:0x6b4a6a, gnd:0x161a2c, sun:0x8a6a7a, amb:0x2a2a48, si:0.22, haze:0.70, fog:0x3a3350, fogD:0.00180 },
  { h:6.6,  zen:0x4a7ba8, hor:0xffb07a, gnd:0x3a3040, sun:0xffb27a, amb:0x50506e, si:0.75, haze:0.85, fog:0xc79a86, fogD:0.00162 },
  { h:9.0,  zen:0x5fa8d6, hor:0xd8e6e8, gnd:0x6a6a68, sun:0xfff0d8, amb:0x8098b0, si:1.00, haze:0.42, fog:0xc8dbe2, fogD:0.00094 },
  { h:13.0, zen:0x4f9fd8, hor:0xe8eee4, gnd:0x74746e, sun:0xfffaf0, amb:0x90a8c0, si:1.10, haze:0.34, fog:0xd6e4e6, fogD:0.00081 },
  { h:17.6, zen:0x4a86bc, hor:0xf2c48a, gnd:0x6a5a52, sun:0xffd9a0, amb:0x7e7a92, si:0.92, haze:0.55, fog:0xe0bb96, fogD:0.00108 },
  { h:19.3, zen:0x2b1e5c, hor:0xff9a56, gnd:0x241a33, sun:0xffb066, amb:0x4a3a68, si:0.70, haze:0.78, fog:0xb56a5e, fogD:0.00144 },
  { h:20.4, zen:0x1a1440, hor:0xa8447e, gnd:0x140f24, sun:0xd0507a, amb:0x2e2450, si:0.32, haze:0.72, fog:0x5c2f52, fogD:0.00171 },
  { h:21.6, zen:0x0a0d1f, hor:0x2a1a3e, gnd:0x07080f, sun:0x3a2a50, amb:0x141a38, si:0.10, haze:0.48, fog:0x14122a, fogD:0.00162 },
  { h:24.0, zen:0x060a1c, hor:0x101a38, gnd:0x05070f, sun:0x223055, amb:0x0d1330, si:0.05, haze:0.35, fog:0x0a0f22, fogD:0.00144 },
];
...
function lerpKeys(h){
  ...
  return {
    zen:mixC(a.zen,b.zen), hor:mixC(a.hor,b.hor), gnd:mixC(a.gnd,b.gnd),
...
export class TimeOfDay {
  ...
  apply(){
    ...
    this._sunElev = elev;
    const dir = new THREE.Vector3(Math.cos(ang)*0.85, elev, -0.42).normalize();
